module legendre_gauss
  contains
    ...
    !
    !    Output, real ( kind = rk ) VP(M,0:N), the values of the derivatives of the
    ...
    !
      ...
      do i = 2, n
        ...
        vp(1:m,i) = ( real ( 2 * i - 1, kind = rk ) * ( v(1:m,i-1) &
                                                       + x(1:m) * vp(1:m,i-1) ) &
...
!      real ( kind = rk ) r8_factorial
    ...
    !
      ...
      real ( kind = rk ), save, dimension ( n_max ) :: fx_vec = (/ &
        0.7071067811865475D+00, & 
        0.3061862178478972D+00, & 
       -0.642337649721702D+00, & 
       -0.6284815141846855D+00, & 
        0.3345637065282053D+00, & 
        0.7967179601799685D+00, & 
        0.06189376866246124D+00, & 
       -0.766588850921089D+00, & 
       -0.4444760242953344D+00, & 
        0.5450094674858101D+00, & 
        0.7167706229835538D+00, & 
        0.0000000000000000D+00, & 
       -0.2759472322745781D+00, & 
       -0.5238320341483518D+00, & 
       -0.7155919752205163D+00, & 
       -0.823164625090267D+00, &  
       -0.8184875533567997D+00, &  
       -0.6734983296193094D+00, &  
       -0.360134523476992D+00, &  
        0.1496662954709581D+00, &  
        0.8839665576253438D+00, & 
        1.870828693386971D+00 /)
      integer ( kind = 4 ) n
      integer ( kind = 4 ) n_data
      integer ( kind = 4 ), save, dimension ( n_max ) :: n_vec = (/ &
         0,  1,  2, &
